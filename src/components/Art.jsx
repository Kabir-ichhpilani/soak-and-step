...
const Art = () => {
    ...
    useGSAP(() => {
        ...
        maskTimeline
            ...
            .to('.masked-img', { scale: 1.3, maskPosition: 'center', maskSize: '400%', duration: 9, ease: 'power1.inOut'})
                ...
                <div className="content">
                    ...
                    <div className="cocktail-img">
                        <img
                            src="/images/r9.jpg"
                            alt="carpet"
                            className="abs-center masked-img rounded-2xl size-full object-contain"
                        />
                    </div>
